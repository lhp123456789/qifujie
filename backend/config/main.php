...
return [
    ...
    'components' => [
        ...
        'log' => [//此项具体详细配置，请访问http://wiki.feehi.com/index.php?title=Yii2_log
            ...
            'targets' => [
                ...
                [
                    ...
                    'message' => [
                        'to' => ['1770080861@qq.com'],//此处修改成自己接收错误的邮箱
                        'subject' => '来自后台的新日志消息',
                    ],
                ],
            ],
        ...
        'urlManager' => [
            'enablePrettyUrl' => false,//true 美化路由(注:需要配合web服务器配置伪静态 false 不美化路由
            ...
            'bundles' => [
                ...
                backend\assets\IndexAsset::className() => [
                    ...
                    'js' => [
                        ...
                        'i' => "js/plugins/layer/layer.min.js",
                        'j' => "js/Particleground.js",
                    ]
                ],
