...
return [
    ...
    '{username} cannot be blank.' => '{Username}不能为空.',
    '{password} cannot be blank.' => '{password}不能为空.',
    ...
    'Are you sure you want to publish?' => '您确定要发布此分类吗？',
    'Are you sure you want to cancel release?' => '您确定要取消发布此分类吗?',

    'Are you sure the company has passed the audit?' => '确定该公司审核通过吗?',
    'Are you sure the company failed the audit?' => '确定该公司审核失败吗?',

    'EnterPass' => '入驻成功',
    'EnterUnPass' => '入驻失败',
    'Are you sure the merchant failed to move in?' => '确定该用户入驻失败吗?',
    'Are you sure the merchant is successful?' => '确定该用户入驻成功吗?',

    'uncategoried' => '未分类',
    'Please select' => '请选择',
    'Please select some' => '请选择一个或多个',
    'Allowed not to be deleted, some article belongs to this category.' => '不允许被删除，还有职业属于此分类',
    'GoodsModel Id' => '分类Id',
    'GoodsModel Images' => '配图',
    ...
    'Active' => '激活',
    'Stop' => '禁用',
    'Are you sure you want to activate this' => '你确定要激活此项吗',
    'Are you sure you want to disable this' => '你确定要禁用此项吗',
    /*Company*/
    'Company Name'=>'公司全称',
    'Company Alias'=>'别名',
    'Company Url'=>'链接',
    'Company Personnner'=>'公司联系人',
    'Company Phone'=>'电话',
    'Cusc'=>'统一社会信用代码',
    'Id Number'=>'身份证号',
    'Business Licese'=>'营业执照',
    'Card Picture'=>'身份证正面',
    'Card Pic'=>'身份证反面',
    'Company Product'=>'公司产品',
    'Company Describe'=>'公司简介',
    'Pass' => '通过',
    'Defeat' => '审核失败',
    'WEB_URL' => '官网链接',
    'Click' => '点击量',
    ...
    'Chose from article category' => '从分类选择',
