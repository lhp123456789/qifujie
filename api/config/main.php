        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                [
                    ...
                    'controller' => ['user', 'public','cities','company', 'paid','navigationbar','options','publish','category'],//通过/users,/user/1,/paid/info访问
                    /*'extraPatterns' => ['GET search' => 'search'],*/
                ],
                [
                    'class' => yii\rest\UrlRule::className(),//v1版本路由，通过/v1/users,/v1/user/1,/v1/paid/info...访问
                    'controller' => ['v1/site', 'v1/user', 'v1/cities','v1/company', 'v1/paid','v1/navigationbar','v1/options','v1/publish','v1/category'],
                ],
