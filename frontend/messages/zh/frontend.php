...
return [
    ...
    'Effective,Professional,Conform to SEO' => '您想要的我们都有',
    ...
    /*site*/
    'Local hot industry' => '本地热门行业',
    'Popular service recommendation' => '热门服务推荐',
    'handy service for the public' => '便民服务',
    ...
    /*article*/
    "Return Home" => '返回首页',
    "GoodsModel id {id} is not exists" => "业务id {id}不存在",
    "Comment" => "评论",
    "Only commented user can visit this article" => "仅对评论过的用户可见,可以点击下方评论后查看",
    'Like' => '赞',
    'Share' => '分享',
    'Go' => '确认',
    'Only login user can visit this article' => '仅对登录用户可见',
    'Search keyword {keyword} results' => '搜索 {keyword} 的结果',
    'Tag {tag} related articles' => 'Tag {tag} 的相关文章',
    'Category {cat} articles' => '分类 {cat} ',
    'Follow Wechat' => '微信公众号',
    'Join group' => '加群啦',
    /*article*/

    /*comment*/
    'This article is not allowed to comment' => '不允许评论',
